...
public class ReceiptsPageResultSetExtractor  implements ResultSetExtractor<ReceiptsPage>{

    @Override
    public ReceiptsPage extractData(ResultSet rs) throws SQLException, DataAccessException {
